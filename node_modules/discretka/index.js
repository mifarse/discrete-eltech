...
var inverse = {
	...
	create: function(){
		result = this.solve();
		delete result.output;
		// emptyTable(result.table); Как и у Ларина
		return result;
	},
	properties: ['input', 'table', 'output']
}
...
var diophantine = {
	solve: function(a,b,c){
		...
		if (a === undefined, b === undefined){
			do {
				a = getRandomInt(1, 200);
				b = getRandomInt(1, 200);
				result = nod.solve(a, b, "no-debug");
		...
		console.log(result)
		d = result.output; // nod
		c = c === undefined ? d*getRandomInt(1, 20): c;
		a1 = a/result.output;
		b1 = b/result.output;
		c1 = c/result.output;
	...
	create: function(){
		result = this.solve();
		delete result.output;
		// emptyTable(result.table); Как и в модуле Ларина, таблица генерируется решенной.
		return result;
	},
	properties: ['input', 'table', 'output']
}
